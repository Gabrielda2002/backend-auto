...
import { GlobalFilters, type FilterOption } from '@/components/filters/global-filters';
import { buildPeriodoOptions, periodoToRange, rangeToPeriodo } from '@/lib/periodos';
